...
<div class="navbar navbar-default">
	...
	<div class="navbar-header">
		<a class="navbar-brand" href="#" onclick="return false;">
			<i><img class="logo-icon" src="<?= $logo ?>"></i>
	...
	<div class="navbar-collapse collapse navbar-responsive-collapse">
		<ul class="nav navbar-nav">
			<li><a class="top-link" href="<?= URL::route('ff-mt-em-demo') ?>">About</a></li>
			<li><a class="top-link" href="<?= URL::route('ff-mt-em-sdk') ?>">SDK</a></li>
			<li><a class="top-link" href="<?= URL::route('ff-mt-em-docs') ?>">Documentation</a></li>
			...
			<?php
			if (Config::get('ff-mt-em::ff.login.enabled')) {
				if (Config::get('ff-mt-em::user_id') > 0) {
					?>
					<li><!--suppress HtmlUnknownTarget -->
						<a class="top-link" href="/logout"><i class="fa fa-sign-out"></i> Logout</a></li><?php
				} else {
					?>
